...
if __name__ == '__main__':
    ...
    print("preparing GPU kernels ...") # by launching the fgcr() solver with only onr step
    a1, a2, a3, a4 = fgcr(dim, blk_dim, vol, 1, res, args.nkv, args.ncy, args.nmr, Dop_ddtype, Mop, b_ddtype_Re, b_ddtype_Im, x0_ddtype_Re, x0_ddtype_Im, ddtype, sdtype, cdtype, xp, xp2, args)
    del a1, a2, a3, a4
    ...
    for i in range(args.runs):
        ...
        x_Re, x_Im, rn, json_data = fgcr(dim, blk_dim, vol, nmx, res, args.nkv, args.ncy, args.nmr, Dop_ddtype, Mop, b_ddtype_Re, b_ddtype_Im, x0_ddtype_Re, x0_ddtype_Im, ddtype, sdtype, cdtype, xp, xp2, args)
        print("time", time.time(), time.time() - lastime); lastime = time.time();
