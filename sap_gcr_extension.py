...
def fgcr(dim, blk_dim, vol, nmx, res, nkv, ncy, nmr, Dop, Mop, eta_ddtype_Re, eta_ddtype_Im, psi_ddtype_Re, psi_ddtype_Im, ddtype, sdtype, cdtype, xp, xp2, args):
    ...
    while rn > tol:
        ...
        for k in itertools.count(0): # k=0, 1, ..., infinite
            ...
            phi_sdtype_Re[k], phi_sdtype_Im[k], chi_sdtype_Re[k], chi_sdtype_Im[k] = Mop(k, rho_sdtype_Re, rho_sdtype_Im, sdtype, cdtype, tol)
            ...
            #chi_sdtype_Re[k], chi_sdtype_Im[k] = axpy(sdtype(1.0)/b[k], chi_sdtype_Re[k], chi_sdtype_Im[k], zero_sdtype, zero_sdtype, sdtype)
...
def sap(i, vol, nmr, psi_Re, psi_Im, rho_Re, rho_Im, bs, Dop_blk, cdtype, xp, xp2, tol):
    ...
    for col, opposite_col in zip([0,1], [1,0]): # 0=black, 1=white
        ...
        for n in range(blk_start, blk_end):
            ...
            blk_psi_Re, blk_psi_Im, blk_rho_Re, blk_rho_Im = blk_mres(n, nmr, blk_rho_Re, blk_rho_Im, cdtype, sdtype, xp2, tol)
    ...
    return psi_Re, psi_Im, rho_Re, rho_Im
    ...
    if args.no_preconditioning:
        ...
        def Mop(k, rho_Re, rho_Im, sdtype, cdtype, tol):
            ...
            for n in range(0, args.ncy):
                phi_Re, phi_Im, chi_Re, chi_Im = sap(n, vol, args.nmr, phi_Re, phi_Im, chi_Re, chi_Im, bs, Dop_blk_sdtype, cdtype, xp, xp2, tol)
                if EXTENSION == 1:
                    rn_old = rn
            ...
            if EXTENSION == 1:
                if n != args.ncy-1: print('sap() icy={0}'.format(n))
